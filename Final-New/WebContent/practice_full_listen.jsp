...
<jsp:include page="pra_full_listen_head.html" />
<%
...
//System.out.println("<source src=\"uploadFile/"+session.getAttribute("lgUser")+"/FullTest/"+session.getAttribute("nameTest")+"/"+read.Read(direct, i)+"\" type=\"audio/mpeg\">");
out.println("<source src=\"uploadFile/"+"/FullTest/"+session.getAttribute("nameTest")+"/"+read.Read(direct, i++)+"\" type=\"audio/mpeg\">");
out.println("</audio>");
...
for(;i<part1*5+1;i+=5){
	...
	//System.out.println("<img src=\"uploadFile/"+session.getAttribute("lgUser")+"/FullTest/"+session.getAttribute("nameTest")+"/"+read.Read(direct, i)+"\" alt=\"File not found\" style=\"width:425px;height:282px;\"><br />");
...
<jsp:include page="pra_full_listen_foot.html" />                                                        