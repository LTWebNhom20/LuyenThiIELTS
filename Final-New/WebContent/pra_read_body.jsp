...
<jsp:include page="pra_read_head.html" />
<%
...
document.getElementById("listening").value=0;
document.getElementById("reading2").value=score;
document.getElementById("listening2").value=0;

}
</SCRIPT>
<jsp:include page="pra_read_foot.html" />                                                        