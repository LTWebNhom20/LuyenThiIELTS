...
System.out.println("<source src=\"uploadFile/FullTest/"+session.getAttribute("nameTest")+"/"+read.Read(direct, i)+"\" type=\"audio/mpeg\">");
...
for(;i<part1*5+1;i+=5){
	...
	System.out.println("<img src=\"uploadFile/FullTest/"+session.getAttribute("nameTest")+"/"+read.Read(direct, i)+"\" alt=\"File not found\" style=\"width:425px;height:282px;\"><br />");
