...
public class doTest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String local="C:\\Users\\HuyDuc\\workspace\\Final-New\\WebContent\\uploadFile\\";
		//If this is do a read test
		if(tmpURI[3].equals("Reading"))
		{
			//Do a reading test with location
			direct=local+"\\"+tmpURI[3]+"\\"+tmpURI[4]+"\\"+"read.xlsx";
		...
		else
		{
			...
			if(tmpURI[3].equals("Listening"))
			{
				...
				direct=local+"\\"+tmpURI[3]+"\\"+tmpURI[4]+"\\"+"listen.xlsx";
			...
			else
			{
				...
				direct=local+"\\"+tmpURI[3]+"\\"+tmpURI[4]+"\\";
